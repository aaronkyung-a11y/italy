  ...
  days: [
    // 9/16 (수) 도착일
    {
      ...
      dayInfo: {
        ...
        hotel: '🏨 H10 Palazzo Galla · Via IV Novembre 102 (트레비/콜로세오 근처) · 체크인',
    ...
    {
      date: '2026-09-18',
      attractionIds: ['stpeter', 'vatican'],
      dayInfo: {
        startCoord: [41.8966, 12.4853],
        title: '성 베드로 대성당 + 바티칸',
        reservations: [
          { time: '09:00', label: '⛪ 성 베드로 대성당 (무료 · 오전이 줄 짧음) · 미켈란젤로 피에타 + 베르니니 열주랑 + 미켈란젤로 돔 + 발다친 · 🚕택시: 목적지 \'Piazza San Pietro\'(성 베드로 광장) · ⚠️어깨·무릎 가리기 필수, 큰 가방 반입 제한 · 돔 등반 유료(선택, 551계단/엘베320)' },
          { time: '14:30', label: '🎨 Vatican Museums · 3매 · 코드 2L2NFG7Y19XTF1TVG · Corridor 1 입구 · 성인 €25급 + Ian 할인 · ⚠️3인 전원 어깨·무릎 가리기(스카프), 시스티나 사진·대화 금지' },
        ],
        hotel: '🏨 H10 Palazzo Galla · Via IV Novembre 102 (숙박 중)',
        note: '08:30 H10에서 택시(목적지 \'Piazza San Pietro\') → 09:00 성 베드로 대성당(무료, 오전이 줄 짧음): 피에타·발다친·베드로의 좌·미켈란젤로 돔 + 베르니니 광장 열주랑, 원하면 돔 등반 → 11:30 보르고 지역 점심(성당 근처) → 14:30 바티칸 박물관 입구는 성벽 돌아 Viale Vaticano 쪽(성당과 다른 입구, 도보 10~15분) → 시스티나. ⚠️두 입구 다름: 성 베드로=광장 쪽, 박물관=Viale Vaticano(Corridor1). 예약 티켓이니 티켓구매 긴 줄 서지 말고 예약자 전용 입구로. 호객꾼 무시. 3인 어깨·무릎 필수(스카프), 시스티나 사진·대화 금지. 스페인계단·산탄젤로는 이번 일정서 제외(시간 집중). H10 주소: Via IV Novembre 102',
      },
    },
    // 9/19 (토) 보르게세 + 로마→피렌체
    {
    ...
    // 9/20 (일) 우피치 + 아카데미아 (David) — 둘 다 확정 예약
    {
      ...
      dayInfo: {
        ...
        reservations: [
          ...
          { time: '13:00', label: '🥩 점심 Oste Via de\' Cerchi 40R · Chianineria (Via de\' Cerchi 40/R, 시뇨리아 광장 옆) · 3명 · 예약번호 4880209 · ☎055 213142 · 30% 할인 (고정메뉴 제외) · 키아니나 비스테카 전문 · 일요일 정상영업(11:00~22:30)', coord: [43.771318, 11.2562831] },
        ...
        note: 'Uffizi 10:00~12:30 → 13:00 Oste Via de\' Cerchi 점심 (우피치서 도보 4분) → 14:30 Accademia 도착 → 15:00 입장 (David·미완성 노예들, 1~1.5h) → → 호텔 휴식(수영장 가능) → 19:00 Osteria Belle Donne 저녁(호텔과 같은 광장, 도보 2분) → 두오모 광장 젤라토. 아카데미아 15:00 확정이라 우피치 후 점심·휴식 버퍼 넉넉 · Pitti는 다음 방문으로 이동',
      },
    },
    ...
    // 9/25 (금) 출국일
    {
      ...
      dayInfo: {
        ...
        transit: [
          ...
          { type: 'boat', label: '⛵ Wave Boat Como 프라이빗 보트 15:00~16:00 (1시간) · 3명 · 선장 Fabio(+39 348 642 2087) · 벨라조 Pier 5, Bar San Remo 앞 집합 · 결제 €100 완료/잔금 €250(현장) · 벨라조·바레나·트레메조 물 위에서' },
        ...
        note: '09:30 밀라노 출발(기사 택시, 벨라조 직행) → 11:00 벨라조 도착 → 마을 산책·실크숍·세르벨로니 정원 골목(90분) → 12:30 La Goletta 점심(호수뷰 테라스) → 식후 벨라조 산책 → 15:00~16:00 Wave Boat 프라이빗 보트 1시간(선장 Fabio, Pier 5 Bar San Remo 앞) → 16:00 젤라토·마지막 산책 → 17:00 벨라조 출발 → MXP 직행(약 1.5h) → 19:00 도착 → 22:00 KE928. ⚠️캐리어는 오전 체크아웃 후 택시 트렁크 · 22시 국제선이라 벨라조 17:00 출발 엄수 · 보트는 미리 예약',
      },
    },
  ],
  bookings: {
    ...
    'gondola': {
      ...
      slotTime: '18:00',
      slotDate: '2026-09-22',
      notes: '예약 불필요 · 카나레조(호텔 근처) 승선장 — Guglie(과이에)/San Marcuola 인근, 도보 5~10분 · 조용한 뒷운하 미끄러지는 경험(산마르코는 9/23) · 30분 €90(19시 전이라 저녁할증 €110 회피) · 최대 5인 동일요금 · 시조례 정찰제(흥정X) · 노을 조망은 곤돌라보다 이후 운하변 산책에서',
    },
    'navona': {
      status: 'visit',
      slotTime: '18:00',
