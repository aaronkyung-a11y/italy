...
export const AARON_CONFIRMED_TRIP = {
  ...
  days: [
    ...
    // 9/18 (금) 로마 광장 + 바티칸
    {
      ...
      dayInfo: {
        ...
        reservations: [
          { time: '10:00', label: '⛪ 성 베드로 대성당 (무료 · 오전이 줄 짧음) · 미켈란젤로 피에타 + 베르니니 발다친 + 베드로의 좌 · ⚠️어깨·무릎 가리기 필수(성당), 큰 가방 반입 제한 · 돔 등반은 유료(선택)' },
        ...
        note: '이른 오전 스페인 계단 → 10:00 성 베드로 대성당(무료, 오전이 줄 짧음 — 미켈란젤로 피에타 꼭 보기, 발다친·베드로의 좌) → 산탄젤로 성(성 베드로서 도보 10분) → 점심 → 14:30 바티칸 박물관+시스티나. 성 베드로를 오전에 단독으로 봐서 오후 바티칸과 이동 중복 없앰 · 체력 좋을 때 피에타 관람. ⚠️성당·바티칸 모두 어깨·무릎 필수(스카프 지참), 시스티나 사진·대화 금지. 트레비·판테온·나보나는 9/17 관람 완료',
      },
    },
    // 9/19 (토) 보르게세 + 로마→피렌체
    {
    ...
    // 9/22 (화) 산타크로체 + 베네치아 이동 (아카데미아는 9/20으로 이동 완료)
    {
      ...
      dayInfo: {
        ...
        note: '09:30 Santa Croce → 11:30 호텔 짐 → 점심 → 14:20 열차 → 16:34 베네치아 도착 → U-Visionary 체크인(카나레조, 역 옆) → 18:00 곤돌라 30분(카나레조 뒷운하 미끄러지기, 호텔 근처 승선장) → 18:45~19:15 노을 산책: 폰다멘타 델라 미세리코르디아 운하변(서쪽 트여 노을 정면, 현지인 아페리티보 스팟) 또는 폰다멘타 누오베(석호 방향, 무라노 실루엣) → 저녁. ⚠️곤돌라 안은 건물에 가려 노을 잘 안 보임 — 노을은 운하변 산책에서. 산마르코는 9/23',
      },
    },
    // 9/23 (수) 베네치아 → 밀라노
    {
  ...
  bookings: {
    'gondola': {
      ...
      slotTime: '18:00',
      slotDate: '2026-09-22',
      notes: '예약 불필요 · 카나레조(호텔 근처) 승선장 — 미세리코르디아/과이에/산 마르쿠올라, 도보 5~10분 · 조용한 뒷운하 미끄러지는 경험(산마르코는 9/23) · 30분 €90(19시 전이라 저녁할증 €110 회피) · 최대 5인 동일요금 · 시조례 정찰제(흥정X) · 노을 조망은 곤돌라보다 이후 운하변 산책에서',
    },
    'navona': {
      status: 'visit',
      slotTime: '18:00',
