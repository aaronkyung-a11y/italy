    ...
    // 9/25 (금) 출국일
    {
      ...
      dayInfo: {
        ...
        transit: [
          ...
          { type: 'boat', label: '⛵ 벨라조 프라이빗 보트 14:00~16:00 (2시간) · 벨라조·바레나·트레메조·발비아넬로(007 저택) 물 위에서 · 임바르카데로(마치니 광장 옆) 선착장 · ⚠️사전 예약 필요' },
        ...
        note: '09:30 밀라노 출발(기사 택시, 벨라조 직행) → 11:00 벨라조 도착 → 마을 산책·실크숍·세르벨로니 정원 골목(90분) → 12:30 La Goletta 점심(호수뷰 테라스) → 14:00~16:00 프라이빗 보트 2시간(골든 트라이앵글: 바레나·트레메조·발비아넬로) → 16:00 젤라토·마지막 산책 → 17:00 벨라조 출발 → MXP 직행(약 1.5h) → 19:00 도착 → 22:00 KE928. ⚠️캐리어는 오전 체크아웃 후 택시 트렁크 · 22시 국제선이라 벨라조 17:00 출발 엄수 · 보트는 미리 예약',
      },
    },
  ],
  bookings: {
