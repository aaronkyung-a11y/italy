  ...
  days: [
    ...
    // 9/20 (일) 우피치 + 아카데미아 (David) — 둘 다 확정 예약
    {
      ...
      dayInfo: {
        ...
        note: 'Uffizi 10:00~12:30 → 점심·휴식 (여유롭게) → 14:30 Accademia 도착 → 15:00 입장 (David·미완성 노예들, 1~1.5h) → → 호텔 휴식(수영장 가능) → 19:00 Osteria Belle Donne 저녁(호텔과 같은 광장, 도보 2분) → 두오모 광장 젤라토. 아카데미아 15:00 확정이라 우피치 후 점심·휴식 버퍼 넉넉 · Pitti는 다음 방문으로 이동',
      },
    },
